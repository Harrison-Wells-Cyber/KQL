...
The bootcamp also provides defensive advice, and KQL for detecting these attacks. However, the KQL is often not production ready, and is generally written for Microsoft Sentinel rather than Defender andvanced hunting.
